...
/*
    For the given text input field, this function will give autocomplete choices and
    apply a choice if selected. The field can be separated by the character ';'.

    Given text input field must be in a div which use the class autocomplete from the
    css file 'autocomplete.css'.

    @param inp: input element from html
    @param arr: array containing the autocomplete propositions
*/
